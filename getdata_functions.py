...
if __name__ == '__main__':
    pass
    # make_clones(snname='SN2013fs',
    #             supyfitspecdir=join(environ['HOME'], 'DropboxWIS/my_spectra_collections/II/2013fs'),
    #             specfile2keep='SN2013fs_2013-10-10_01-01-28_ESO-NTT_EFOSC2-NTT_PESSTO-SSDR.dat')
