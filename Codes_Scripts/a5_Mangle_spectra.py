...
class SingleSpectrumClass():
    ...
    def check_spec_manglingphot(self):
        ...
        for spec_file in all_specs:
            ...
            if len(phot4mangling[mask]) == 0:
                print('There.s no magnling photometry fro this. Are you sure nothing went wrong in the step 4_LCfit?',
                      spec_file)
    ...
    def mangle_spectrum_function(self, show=False):
        ...
        if len(ratios) < 1:
            ...
            ax2.errorbar(self.magled_photometry_dict['eff_wls'], self.magled_photometry_dict['fitted_phot'], marker='^',
