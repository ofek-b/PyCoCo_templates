...
vega = fits.open(dirname(__file__) + '/alpha_lyr_stis_006.fits')
...
class Band_Vega(object):
    ...
    def _zpFluxesFlam(self):
        ...
        F_Vega_interp = np.interp(wavelength_array.value, w_Vega,
                                  f_Vega) * u.erg / u.s / u.cm ** 2 / u.AA  # OFEK: added .value
